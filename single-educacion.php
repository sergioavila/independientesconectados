            ...
            <?php if ( is_user_logged_in() ) {?>
               <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="my4 d-flex educacion-datos">
                        <p><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="#4C7DFB"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20ZM13 12H17V14H11V7H13V12Z"></path></svg> Lectura: <?php echo get_estimated_reading_time(get_the_content()); ?></p>
                        <?php if(get_field('tiempo')):?>
                        <p><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="#4C7DFB"><path d="M3 3.9934C3 3.44476 3.44495 3 3.9934 3H20.0066C20.5552 3 21 3.44495 21 3.9934V20.0066C21 20.5552 20.5551 21 20.0066 21H3.9934C3.44476 21 3 20.5551 3 20.0066V3.9934ZM5 5V19H19V5H5ZM10.6219 8.41459L15.5008 11.6672C15.6846 11.7897 15.7343 12.0381 15.6117 12.2219C15.5824 12.2658 15.5447 12.3035 15.5008 12.3328L10.6219 15.5854C10.4381 15.708 10.1897 15.6583 10.0672 15.4745C10.0234 15.4088 10 15.3316 10 15.2526V8.74741C10 8.52649 10.1791 8.34741 10.4 8.34741C10.479 8.34741 10.5562 8.37078 10.6219 8.41459Z"></path></svg> Video: <?php echo get_field('tiempo');?></p>
                        <?php endif;?>
                    </div>
                    <div class="my-4">
                    <?php the_content(); ?>
                    </div>
                    <div class="embed-responsive w-100 my-4 video-border">
                        <?php echo get_field('video');?>
                    </div>
                    <div>
                    <?php if(get_field('pdf')):?>
                        <a href="<?php echo get_field('pdf');?>" class="btn btn-primary btn-blue" download>Descargar material</a>
                    <?php endif;?>
                    </div>
                    <p class="disclaimer"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="12" height="12" fill="rgba(10,14,119,1)"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20ZM11 15H13V17H11V15ZM11 7H13V13H11V7Z"></path></svg> Este contenido podría presentar información comercial y promocional de productos farmacéuticos.  La información presentada aplica sólo para Chile.</p>
                </div>
                <div class="col-lg-4">
                    <div class="card mb-5 card-blue">
                        <div class="text-center p-4">
                            <p>Realiza este pequeño quiz y podrás ganar </p>
                            <div>
                                <p class="mb-4 fs-5"><strong><?php echo get_field('puntos');?></strong> puntos conectados</p>
                ...
                <script>
                    ...
                    jQuery(document).ready(function(){
                        ...
                        //search nav-link and add class active
